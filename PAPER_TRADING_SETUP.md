...
KALSHI_API_KEY=your_api_key_if_available
...
2. **Get credentials:** Email, password, API key
3. **Update .env:** Add your credentials
4. **Test connection:** Run `python test_kalshi_connection.py`
5. **Start paper trading:** Run `python run_paper_trading.py`
