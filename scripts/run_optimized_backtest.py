...
class OptimizedBacktest(HistoricalBacktest):
    ...
    def __init__(self, n_games: int = 50, profile: str = "conservative", initial_capital: float = 10000.0, **kwargs):
        """
        ...
        # Initialize parent
        super().__init__(n_games=n_games, agent_config=agent_config, initial_capital=initial_capital, **kwargs)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run optimized backtest with risk management")
    parser.add_argument("--games", type=int, default=50, help="Number of games to simulate (default: 50)")
    parser.add_argument(
        "--profile",
        type=str,
    ...
    parser.add_argument("--season", type=int, default=2024, help="NFL season for real data (default: 2024)")
