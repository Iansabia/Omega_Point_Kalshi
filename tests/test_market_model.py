...
class TestPredictionMarketModel:
    ...
    def test_model_initialization_with_config(self):
        ...
        config = {"market": {"initial_price": 0.65, "tick_size": 0.01}}
    ...
    def test_initialize_noise_traders(self):
        ...
        agent_config = {
            "noise_trader": {"count": 10, "wealth_distribution": {"type": "lognormal", "mean": 1000, "sigma": 0.5}}
        }
    ...
    def test_initialize_informed_traders(self):
        ...
        agent_config = {"informed_trader": {"count": 5, "wealth": 10000, "information_quality": 0.8}}
    ...
    def test_initialize_arbitrageurs(self):
        ...
        agent_config = {"arbitrageur": {"count": 3, "wealth": 50000, "detection_speed": 0.9}}
    ...
    def test_initialize_market_makers(self):
        ...
        agent_config = {"market_maker": {"count": 2, "wealth": 100000, "risk_param": 0.1}}
    ...
    def test_initialize_homer_agents(self):
        ...
        agent_config = {"homer_agent": {"count": 4, "wealth": 2000, "loyalty_strength": 0.7}}
    ...
    def test_initialize_llm_agents(self):
        ...
        agent_config = {"llm_agent": {"count": 2, "wealth": 10000, "risk_profile": "conservative"}}
    ...
    def test_agent_wealth_conservation(self):
        ...
        agent_config = {"noise_trader": {"count": 10}, "market_maker": {"count": 2}}
        model = PredictionMarketModel(agent_config=agent_config, seed=42)
        ...
        final_wealth = sum(agent.wealth + agent.position * model.current_price for agent in model.agents)
